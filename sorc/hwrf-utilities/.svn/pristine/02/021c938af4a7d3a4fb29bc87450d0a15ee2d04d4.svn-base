program da_update_analysis_main

  !=======================================================================

  !$$$ PROGRAM DOCUMENTATION BLOCK
  
  ! da-update-analysis :: da_update_analysis_main
  ...
  use da_update_analysis_interface
  ...
  call da_update_analysis()

  !=======================================================================

end program da_update_analysis_main
