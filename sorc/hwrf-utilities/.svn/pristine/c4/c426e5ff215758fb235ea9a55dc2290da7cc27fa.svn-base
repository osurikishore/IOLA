    ...
    if(iih_rt(i,j).gt.0.and.jjh_rt(i,j).gt.0) then
       ...
       if(dis.lt.0.005)then
          ...
          if(alpha.ge.cint1.and.alpha.lt.cint2)then
            ...
            dis1=dis*sin(beta)
            dis2=dis*cos(beta)
            if(dis1.lt.(-0.001).or.dis1.gt.1.005.or.      &
               dis2.lt.(-0.001).or.dis2.gt.1.005)then
              print*,'qliu test wrong1=',i,j,dis,dis1,dis2,beta
              stop
            else
              if(dis1.gt.1.002)dis1=1.002
              if(dis2.gt.1.002)dis2=1.002
            end if
            ...
            dis1=dis*sin(beta)
            dis2=dis*cos(beta)
            if(dis1.lt.(-0.0015).or.dis1.gt.1.005.or.      &
               dis2.lt.(-0.0015).or.dis2.gt.1.005)then
