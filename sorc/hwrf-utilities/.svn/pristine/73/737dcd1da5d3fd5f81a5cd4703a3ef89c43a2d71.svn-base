...
#ifndef VERSION
#define WGRIB2_VERSION "v0.2.0.3 11/2015 Wesley Ebisuzaki, Reinoud Bokhorst, John Howard, Jaakko Hyvätti, Dusan Jovic, \
...
int uint4_missing(unsigned const char *);
...
int rdieee_file(float *array, int n, int header, struct seq_file *input);
...
int min_max_array(float *data, int n, float *min, float *max);
