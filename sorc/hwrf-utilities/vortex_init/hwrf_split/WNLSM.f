...
C     Biju T: Revised by removing the ASSIGNED GO TO Statements, Feb 21, 2020 
C
...
C     COPY RT. HAND SIDE INTO TEMP VECTOR TO USE OVERWRITING METHOD.
 ...
 1190 GO TO 1270
 1200 CONTINUE
      IF (IGO986 == 40) GO TO 40
 1210 CONTINUE
      IF (IGO980 == 90) GO TO 90
 1220 CONTINUE
      IF (IGO991 == 30) GO TO 30
 1230 CONTINUE
      IF (IGO998 == 10) GO TO 10
 1240 CONTINUE
      IF (IGO995 == 20) GO TO 20
 1250 CONTINUE
      IF (IGO983 == 60) GO TO 60
 1260 CONTINUE
      IF (IGO977 == 220) GO TO 220
 1270 CONTINUE
      IF (IGO958 == 310) GO TO 310
      IF (IGO958 == 1010) GO TO 1010 
 1280 CONTINUE
      IF (IGO897 == 880) GO TO 880
      IF (IGO897 == 900) GO TO 900
 1290 CONTINUE
      IF (IGO938 == 460) GO TO 460
      IF (IGO938 == 480) GO TO 480
      IF (IGO938 == 500) GO TO 500
      IF (IGO938 == 520) GO TO 520
      END
