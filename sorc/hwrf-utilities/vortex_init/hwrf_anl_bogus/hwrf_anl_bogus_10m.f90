...
!         CALL CORT_N(NX,NY,KMX,U_1,V_1,T_1,Q_1,SLP_1,TENV,TH1,RP,          &
!                    psfc_obs1,vobs,HLON,HLAT,VLON,VLAT,               &
!                    CLON_NEW,CLAT_NEW,beta,ics,RMAX,PRMAX,PW,RIJ)
