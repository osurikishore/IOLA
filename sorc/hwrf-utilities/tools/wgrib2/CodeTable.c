...
unsigned char *code_table_4_1_location(unsigned char **sec) {
    ...
    if (p == 50008 && (center == JMA1 || center == JMA2)) return sec[4] + 9;
    return NULL;
}
...
unsigned char *code_table_4_3_location(unsigned char **sec) {
    ...
    case 52:
        return sec[4]+13; break;
    case 50008:
	if (center == JMA1 || center == JMA2) return sec[4]+11;
	return NULL;
	break;
    default:
        return NULL;
...
unsigned char *code_table_4_5a_location(unsigned char **sec) {
    ...
    case 254:
        return NULL; break;
    case 50008:
	if (center == JMA1 || center == JMA2) return sec[4] + 22;
        return NULL;
        break;
    default:
...
unsigned char *code_table_4_5b_location(unsigned char **sec) {
    ...
    case 254:
        return NULL; break;
    case 50008:
	if (center == JMA1 || center == JMA2) return sec[4] + 28;
        return NULL;
        break;
    default:
