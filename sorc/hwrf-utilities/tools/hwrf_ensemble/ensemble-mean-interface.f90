module ensemble_mean_interface
...
contains
  ...
  ! ensemble_mean_wrfnmm.f90:

  !-----------------------------------------------------------------------

  subroutine ensemble_mean_wrfnmm()
    ...
    if(mpi_procid .eq. mpi_masternode) then
       ...
       call ensemble_mean_wrfnmm_write(ens_mean)
  ...
  end subroutine ensemble_mean_wrfnmm

  !=======================================================================

  ! ensemble_mean_wrfnmm_write.f90:

  !-----------------------------------------------------------------------

  subroutine ensemble_mean_wrfnmm_write(grid)
  ...
  end subroutine ensemble_mean_wrfnmm_write

  !=======================================================================

end module ensemble_mean_interface
