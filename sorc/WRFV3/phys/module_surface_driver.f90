...
CONTAINS
   ...
   SUBROUTINE surface_driver(                                         &
     ...
     &          ,zkmax,ribn,charn,msang,scurx,scury,icoef_sf,iwavecpl,lcurr_sf & 
         ...
         ENDIF
          ...
          CALL SFCDIAGS(HFX,QFX,TSK,QSFC,CHS2,CQS2,T2,TH2,Q2,      &
           ...
           DO i=i_start(ij),i_end(ij)
              TSHLTR(I,J)=TH2(I,J)
              QSHLTR(I,J)=Q2(I,J)
              TLOW(I,J) = T_PHY(I,LOWLYR(I,J),J)
              PSHLTR(I,J)=PSFC(I,J)*EXP(-0.068283/TLOW(I,J))
           ENDDO
           ENDDO
...
'Lacking arguments for P-X LSM in surface driver')
     ...
     IF (MYJ) call wrf_error_fatal3("<stdin>",3198,&
