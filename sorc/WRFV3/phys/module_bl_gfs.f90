...
CONTAINS
   ...
   SUBROUTINE BL_GFS(U3D,V3D,TH3D,T3D,QV3D,QC3D,QI3D,P3D,PI3D,     &
                  ...
                  VAR_RIC,                                         &    
                  U10,V10,ZNT,MZNT,rc2d,                           &    
                  DKU3D,DKT3D,coef_ric_l,coef_ric_s,xland,         &    
      ...
      REAL,    INTENT(IN) :: VAR_RIC,coef_ric_l,coef_ric_s                   
      REAL,  DIMENSION(ims:ime, jms:jme), INTENT(IN) ::                 &
                                        SCURX,                          &
                                        SCURY,                          &
                                        MSANG
...
real(kind=kind_phys) RO(IM),xland1(IM)
     ...
     &                     AT(IM,KM*(ntrac-1)),DKU(IM,KM-1),DKT(IM,KM-1),WSPM(IM,KM-1) 
     ...
     &                     zfmin,   zk,     tem1
      ...
      integer,save :: ens_random_seed_local 
