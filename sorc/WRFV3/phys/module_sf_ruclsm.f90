...
print *,'INFMAX,INFMAX1,HYDRO(1)*SOILIQW(1),-TOTLIQ', &
  ...
  10   I1=I
   ...
   1   PRINT *,'     AVOST IN VILKA     Table index= ',I
       ...
       CALL wrf_error_fatal3("module_sf_ruclsm.b",6561,&
'  Crash in surface energy budget  ' )
 ...
 IF(.not.restart)THEN
   ...
   IF ( errflag .EQ. 1 ) THEN
      CALL wrf_error_fatal3("module_sf_ruclsm.b",7142,&
  ...
  END SUBROUTINE ruclsminit
       ...
       IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",7278,&
message )
        END IF
 ...
 2000   FORMAT (A8)
        ...
        IF (LUMATCH == 1) then
           ...
           if ( ierr /= 0 ) call wrf_error_fatal3("module_sf_ruclsm.b",7345,&
"Problem read URBAN from VEGPARM.TBL")
 ...
 2002   CONTINUE
    ...
    ENDIF
        ...
        IF (LUMATCH == 0) then
           CALL wrf_error_fatal3("module_sf_ruclsm.b",7359,&
"Land Use Dataset '"//MMINLURUC//"' not found in VEGPARM.TBL.")
      ...
      IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",7398,&
message )
        END IF
 ...
 2003   CONTINUE
      ...
      IF(LUMATCH.EQ.0)THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",7459,&
'INCONSISTENT OR MISSING SOILPARM FILE' )
      ...
      IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",7471,&
message )
        END IF
