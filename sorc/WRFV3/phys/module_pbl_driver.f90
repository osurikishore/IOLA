...
CONTAINS
   ...
   USE module_state_description, ONLY :                            &
                   ...
                   , GBMPBLSCHEME, MYJSFCSCHEME, MYNNPBLSCHEME2, MYNNPBLSCHEME3 
   ...
   INTEGER,    INTENT(IN   )    ::     ysu_topdown_pblmix, ysu_firstorder, ysu_cgrad_scalar, ysu_cgrad_mom 
 ...
 INTENT(OUT) ::  DKU3D,DKT3D                      
   ...
   INTEGER, OPTIONAL, DIMENSION( ims:ime , jms:jme ),           &
        &    INTENT(OUT) ::               nupdraft,ktop_shallow
  ...
  real,   dimension( ims:ime, jms:jme )                                      , &
   ...
   LOGICAL :: radiation
   LOGICAL :: flag_bep
   LOGICAL :: flag_myjsfc, flag_gfdlsfc 
   ...
   REAL :: z0,z1,z2,w1,w2
   real wmax,wmin 
   REAL,       DIMENSION( ims:ime , jms:jme ) :: fm_,fhh_ 
   ...
   REAL                                                           ::   scrp1
    ...
    if(sf_sfclay_physics.eq.88)then
      flag_gfdlsfc=.true.
    else
      flag_gfdlsfc=.false.
    endif
...
'Lack arguments to call TEMF pbl')
    ...
    write(6,*) " sf_sfclay_physics = ",sf_sfclay_physics
       if(flag_gfdlsfc)then
         fm_ = psim
         fhh_ = psih
         write(6,*) " CALLING YSU with fm=psim, fhh=psih "
       else
         fm_ = fm
         fhh_ = fhh
         write(6,*) " CALLING YSU with fm, fhh as standard with sfclayrev "
       endif
             ...
             CALL ysu(                                              &
              ...
              ,PSIM=fm_,PSIH=fhh_,GZ1OZ0=gz1oz0,XLAND=xland         & 
           ...
           ELSE
               WRITE ( message , FMT = '(A,4(L1,1X))' )             &
                 ...
                 'rqcblten = ',                                     &
                  ...
                  PRESENT( rqcblten )
               CALL wrf_debug(0,message)
               CALL wrf_error_fatal3("<stdin>",1330,&
           ...
           ELSE
               WRITE ( message , FMT = '(A,4(L1,1X))' )             &
                 ...
                 'rqcblten = ' ,                                    &
                  ...
                  PRESENT( rqcblten )
               CALL wrf_debug(0,message)
               CALL wrf_error_fatal3("<stdin>",1405,&
...
'Lack arguments to call ACM2 pbl')
        ...
        CASE (MYNNPBLSCHEME2, MYNNPBLSCHEME3)
           CALL wrf_debug(100,'calling MYNNPBL')
