...
SUBROUTINE med_add_config_info_to_grid ( grid )
 ...
 grid % spp_mp                     = model_config_rec % spp_mp (grid%id)
 grid % gridpt_stddev_spp_mp       = model_config_rec % gridpt_stddev_spp_mp (grid%id)
 grid % stddev_cutoff_spp_mp       = model_config_rec % stddev_cutoff_spp_mp (grid%id)
 grid % lengthscale_spp_mp         = model_config_rec % lengthscale_spp_mp (grid%id)
 grid % timescale_spp_mp           = model_config_rec % timescale_spp_mp (grid%id)
 grid % vertstruc_spp_mp           = model_config_rec % vertstruc_spp_mp 
 grid % iseed_spp_mp               = model_config_rec % iseed_spp_mp 
 grid % isppt_mp                   = model_config_rec % isppt_mp (grid%id)
 grid % gridpt_stddev_isppt_mp     = model_config_rec % gridpt_stddev_isppt_mp (grid%id)
 grid % stddev_cutoff_isppt_mp     = model_config_rec % stddev_cutoff_isppt_mp (grid%id)
 grid % lengthscale_isppt_mp       = model_config_rec % lengthscale_isppt_mp (grid%id)
 grid % timescale_isppt_mp         = model_config_rec % timescale_isppt_mp (grid%id)
 grid % vertstruc_isppt_mp         = model_config_rec % vertstruc_isppt_mp 
 grid % iseed_isppt_mp             = model_config_rec % iseed_isppt_mp 
 grid % isppt_pbl                  = model_config_rec % isppt_pbl (grid%id)
 grid % gridpt_stddev_isppt_pbl    = model_config_rec % gridpt_stddev_isppt_pbl (grid%id)
 grid % stddev_cutoff_isppt_pbl    = model_config_rec % stddev_cutoff_isppt_pbl (grid%id)
 grid % lengthscale_isppt_pbl      = model_config_rec % lengthscale_isppt_pbl (grid%id)
 grid % timescale_isppt_pbl        = model_config_rec % timescale_isppt_pbl (grid%id)
 grid % vertstruc_isppt_pbl        = model_config_rec % vertstruc_isppt_pbl 
 grid % iseed_isppt_pbl            = model_config_rec % iseed_isppt_pbl 
 grid % isppt_rad                  = model_config_rec % isppt_rad (grid%id)
 grid % gridpt_stddev_isppt_rad    = model_config_rec % gridpt_stddev_isppt_rad (grid%id)
 grid % stddev_cutoff_isppt_rad    = model_config_rec % stddev_cutoff_isppt_rad (grid%id)
 grid % lengthscale_isppt_rad      = model_config_rec % lengthscale_isppt_rad (grid%id)
 grid % timescale_isppt_rad        = model_config_rec % timescale_isppt_rad (grid%id)
 grid % vertstruc_isppt_rad        = model_config_rec % vertstruc_isppt_rad 
 grid % iseed_isppt_rad            = model_config_rec % iseed_isppt_rad 
 grid % isppt_conv                 = model_config_rec % isppt_conv (grid%id)
 grid % gridpt_stddev_isppt_conv   = model_config_rec % gridpt_stddev_isppt_conv (grid%id)
 grid % stddev_cutoff_isppt_conv   = model_config_rec % stddev_cutoff_isppt_conv (grid%id)
 grid % lengthscale_isppt_conv     = model_config_rec % lengthscale_isppt_conv (grid%id)
 grid % timescale_isppt_conv       = model_config_rec % timescale_isppt_conv (grid%id)
 grid % vertstruc_isppt_conv       = model_config_rec % vertstruc_isppt_conv 
 grid % iseed_isppt_conv           = model_config_rec % iseed_isppt_conv 
 ...
 grid % isppt_on                   = model_config_rec % isppt_on 
 ...
 grid % corral_x                   = model_config_rec % corral_x (grid%id)
 grid % corral_y                   = model_config_rec % corral_y (grid%id)
 ...
 grid % ocean_cpl                  = model_config_rec % ocean_cpl 
 grid % num_moves                  = model_config_rec % num_moves (grid%id)
 grid % vortex_interval            = model_config_rec % vortex_interval (grid%id)
 grid % corral_dist                = model_config_rec % corral_dist (grid%id)
 grid % multi_storm                = model_config_rec % multi_storm 
 grid % no_ocean                   = model_config_rec % no_ocean 
 ...
 grid % ysu_firstorder             = model_config_rec % ysu_firstorder 
 grid % ysu_brcr_ub                = model_config_rec % ysu_brcr_ub 
 grid % ysu_cgrad_scalar           = model_config_rec % ysu_cgrad_scalar 
 grid % ysu_cgrad_mom              = model_config_rec % ysu_cgrad_mom 
 ...
 grid % idcor                      = model_config_rec % idcor 
 ...
 grid % ishallow                   = model_config_rec % ishallow (grid%id)
 ...
 grid % ntrack                     = model_config_rec % ntrack (grid%id)
 ...
 grid % nhmove                     = model_config_rec % nhmove (grid%id)
 ...
 grid % dwdt_damping_lev           = model_config_rec % dwdt_damping_lev (grid%id)
