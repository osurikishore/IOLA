...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: vertstrucc
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: vertstrucs
integer   ,DIMENSION(1:grid%num_stoch_levels)           :: force_sppt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: ru_tendf_stoch
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: rv_tendf_stoch
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: rt_tendf_stoch
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: rand_pert
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: rstoch
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: field_spp_mp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: pattern_spp_mp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: pattern_isppt_mp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: pattern_isppt_pbl
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: pattern_isppt_rad
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: pattern_isppt_conv
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: rand_real
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,1:grid%num_stoch_levels)           :: rand_imag
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spstreamforcc
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spstreamforcs
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spstream_amp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: sptforcc
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: sptforcs
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spt_amp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcc
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcs
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: sp_amp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spptforcc
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spptforcs
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: sppt_amp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcc_isppt_mp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcs_isppt_mp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: sp_amp_isppt_mp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcc_isppt_pbl
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcs_isppt_pbl
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: sp_amp_isppt_pbl
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcc_isppt_rad
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcs_isppt_rad
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: sp_amp_isppt_rad
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcc_isppt_conv
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcs_isppt_conv
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: sp_amp_isppt_conv
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcc_spp_mp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: spforcs_spp_mp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: sp_amp_spp_mp
real      ,DIMENSION(grid%sm33:grid%em33)           :: vertampt
real      ,DIMENSION(grid%sm33:grid%em33)           :: vertampuv
integer   ,DIMENSION(grid%sm33:grid%em33)           :: iseedarr_rand_pert
integer   ,DIMENSION(grid%sm33:grid%em33)           :: iseedarr_sppt
integer   ,DIMENSION(grid%sm33:grid%em33)           :: iseedarr_skebs
integer   ,DIMENSION(grid%sm33:grid%em33)           :: iseedarr_isppt_mp
integer   ,DIMENSION(grid%sm33:grid%em33)           :: iseedarr_isppt_pbl
integer   ,DIMENSION(grid%sm33:grid%em33)           :: iseedarr_isppt_rad
integer   ,DIMENSION(grid%sm33:grid%em33)           :: iseedarr_isppt_conv
integer   ,DIMENSION(grid%sm33:grid%em33)           :: iseedarr_spp_mp
real      ,DIMENSION(grid%sm31x:grid%em31x,grid%sm32x:grid%em32x,1:grid%num_stoch_levels)           :: rand_real_xxx
real      ,DIMENSION(grid%sm31y:grid%em31y,grid%sm32y:grid%em32y,1:grid%num_stoch_levels)           :: rand_real_yyy
real      ,DIMENSION(grid%sm31x:grid%em31x,grid%sm32x:grid%em32x,1:grid%num_stoch_levels)           :: rand_imag_xxx
real      ,DIMENSION(grid%sm31y:grid%em31y,grid%sm32y:grid%em32y,1:grid%num_stoch_levels)           :: rand_imag_yyy
...
integer   ,DIMENSION(1:100)              :: nest_imid
integer   ,DIMENSION(1:100)              :: nest_jmid
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: cuprecip_swath
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: suswind
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: wind10_ratio
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: suswind_swath
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: hres_lu_index
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: varlen
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: hadjust
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: scurx
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: scury
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: charn
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: msang
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: rchno
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: zsig1
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: ulowl
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: vlowl
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: scalefun
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: scalefun1
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: sigmu
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: sigmu1
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: dthcudt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: dqvcudt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: dqrcudt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: dqccudt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: dqicudt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: dqscudt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: dthbldt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: dqvbldt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: dubldt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: dvbldt
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: qc_bl
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: cldfra_bl
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: gd_cldfr
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: xmb_shallow
integer   ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: k22_shallow
integer   ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: kbcon_shallow
integer   ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: ktop_shallow
integer   ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: ierr_shallow
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: hrswpd
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: hrlwpd
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: swddir
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: swddirc
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: swddni
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: swddnic
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: qv_ins
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32,grid%sm33:grid%em33)           :: train_ins
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: qke
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: qshear
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: qbuoy
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: qdiss
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: qwt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: dqke
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: tsq
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: qsq
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: cov
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: sh3d
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: ch
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: edmf_a
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: edmf_w
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: edmf_thl
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: edmf_qt
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: edmf_ent
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: edmf_qc
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: fgdp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: dfgdp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: vdfg
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: tke_mynn
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: rainsh
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: rainshv
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: shall
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: acrunoff
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: cdx
...
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: udr_kf
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: ddr_kf
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: uer_kf
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm33:grid%em33,grid%sm32:grid%em32)           :: der_kf
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: timec_kf
...
real      ,DIMENSION(grid%sm31:grid%em31,1:8,grid%sm32:grid%em32)           :: soilcomp
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: soilcl1
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: soilcl2
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: soilcl3
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: soilcl4
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: grainxy
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: gddxy
real      ,DIMENSION(grid%sm31:grid%em31,1:5,grid%sm32:grid%em32)           :: croptype
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: planting
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: harvest
real      ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: season_gdd
integer   ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: cropcat
integer   ,DIMENSION(grid%sm31:grid%em31,grid%sm32:grid%em32)           :: pgsxy
real      ,DIMENSION(grid%sm31:grid%em31,1:60,grid%sm32:grid%em32)           :: gecros_state
