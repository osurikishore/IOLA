...
mytask, ntasks, ntasks_x, ntasks_y,       &
ids, ide, jds, jde, 1, 10,             &
ims, ime, jms, jme, 1, 10,             &
ips, ipe, jps, jpe, 1, 10              )
ENDIF
IF ( SIZE(grid%lake_icefrac3d,1)*SIZE(grid%lake_icefrac3d,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%lake_icefrac3d, 4,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
4, 0, 0, DATA_ORDER_XZY, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
...
4, 0, 0, DATA_ORDER_XZY, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
ids, ide, jds, jde, 1, 15,             &
ims, ime, jms, jme, 1, 15,             &
ips, ipe, jps, jpe, 1, 15              )
ENDIF
...
4, 0, 0, DATA_ORDER_XZY, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
ids, ide, jds, jde, 1, 16,             &
ims, ime, jms, jme, 1, 16,             &
ips, ipe, jps, jpe, 1, 16              )
ENDIF
...
CALL RSL_LITE_PACK ( local_communicator,&
 grid%rv_tendf_stoch, 4,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
4, 0, 0, DATA_ORDER_XYZ, 1, &
mytask, ntasks, ntasks_x, ntasks_y,       &
ids, ide, jds, jde, 1, config_flags%num_stoch_levels,             &
ims, ime, jms, jme, 1, config_flags%num_stoch_levels,             &
ips, ipe, jps, jpe, 1, config_flags%num_stoch_levels              )
...
4, 0, 0, DATA_ORDER_XZY, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
ids, ide, jds, jde, 1, config_flags%num_snow_layers,             &
ims, ime, jms, jme, 1, config_flags%num_snow_layers,             &
ips, ipe, jps, jpe, 1, config_flags%num_snow_layers              )
ENDIF
...
4, 0, 0, DATA_ORDER_XZY, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
ids, ide, jds, jde, 1, config_flags%num_snso_layers,             &
ims, ime, jms, jme, 1, config_flags%num_snso_layers,             &
ips, ipe, jps, jpe, 1, config_flags%num_snso_layers              )
ENDIF
...
4, 0, 0, DATA_ORDER_XZY, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
ids, ide, jds, jde, 1, 60,             &
ims, ime, jms, jme, 1, 60,             &
ips, ipe, jps, jpe, 1, 60              )
ENDIF
   CALL RSL_LITE_EXCH_Y ( local_communicator , mytask, ntasks, ntasks_x, ntasks_y, &
                          rsl_sendw_m,  rsl_sendw_p, rsl_recvw_m,  rsl_recvw_p    )
IF ( SIZE(grid%lakedepth2d,1)*SIZE(grid%lakedepth2d,2) .GT. 1 ) THEN
