...
SUBROUTINE HALO_NMM_RAD_sub ( grid, &
  local_communicator, &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_RAD_inline.inc')
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_RAD_sub
...
SUBROUTINE HALO_NMM_TURBL_A_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_TURBL_A_inline.inc')
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_TURBL_A_sub
...
SUBROUTINE HALO_NMM_TURBL_B_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_TURBL_B_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_TURBL_B_sub
...
SUBROUTINE HALO_NMM_TRACK_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_TRACK_inline.inc')
CALL rsl_comm_iter_init(5,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 5 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_TRACK_sub
...
SUBROUTINE HALO_NMM_FORCE_DOWN_SST_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_FORCE_DOWN_SST_inline.inc')
CALL rsl_comm_iter_init(5,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 5 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL wrf_debug(2,'calling inc/HALO_NMM_WEIGHTS_inline.inc')
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_WEIGHTS_sub
...
SUBROUTINE HALO_NMM_SAS_A_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_SAS_A_inline.inc')
...
SUBROUTINE HALO_NMM_SAS_B_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_SAS_B_inline.inc')
CALL rsl_comm_iter_init(2,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 2 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_SAS_B_sub
...
SUBROUTINE HALO_TRACERS_sub ( grid, &
  num_szj, &
  szj, &
  num_s1z, &
  s1z, &
...
CALL wrf_debug(2,'calling inc/HALO_TRACERS_inline.inc')
CALL rsl_comm_iter_init(3,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 3 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
DO itrace = PARAM_FIRST_SCALAR, num_szj
 IF ( SIZE(szj,1)*SIZE(szj,2) .GT. 1 ) THEN
  CALL RSL_LITE_PACK ( local_communicator,&
szj ( grid%sm31,grid%sm32,grid%sm33,itrace),3,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
4, 0, 0, DATA_ORDER_XYZ, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
...
DO itrace = PARAM_FIRST_SCALAR, num_s1z
 IF ( SIZE(s1z,1)*SIZE(s1z,2) .GT. 1 ) THEN
  CALL RSL_LITE_PACK ( local_communicator,&
s1z ( grid%sm31,grid%sm32,grid%sm33,itrace),3,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
4, 0, 0, DATA_ORDER_XYZ, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
...
DO itrace = PARAM_FIRST_SCALAR, num_spz
 IF ( SIZE(spz,1)*SIZE(spz,2) .GT. 1 ) THEN
  CALL RSL_LITE_PACK ( local_communicator,&
spz ( grid%sm31,grid%sm32,grid%sm33,itrace),3,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
4, 0, 0, DATA_ORDER_XYZ, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
...
DO itrace = PARAM_FIRST_SCALAR, num_tcs
 IF ( SIZE(tcs,1)*SIZE(tcs,2) .GT. 1 ) THEN
  CALL RSL_LITE_PACK ( local_communicator,&
tcs ( grid%sm31,grid%sm32,grid%sm33,itrace),3,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
4, 0, 0, DATA_ORDER_XYZ, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_TRACERS_sub
...
SUBROUTINE HALO_NMM_TERRAIN_SMOOTH_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_TERRAIN_SMOOTH_inline.inc')
CALL rsl_comm_iter_init(2,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 2 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_TERRAIN_SMOOTH_sub
...
SUBROUTINE HALO_NMM_MSLP_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_MSLP_inline.inc')
CALL rsl_comm_iter_init(2,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 2 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_MSLP_sub
...
SUBROUTINE HALO_NMM_VT4_MSLP_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_VT4_MSLP_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_VT4_MSLP_sub
...
SUBROUTINE HALO_NMM_VT4_NOISE_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_VT4_NOISE_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_VT4_NOISE_sub
...
SUBROUTINE HALO_NMM_INTERP_INFO_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_INTERP_INFO_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_INTERP_INFO_sub
...
SUBROUTINE HALO_NMM_INT_UP_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_INT_UP_inline.inc')
CALL rsl_comm_iter_init(5,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 5 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_INT_UP_sub
...
SUBROUTINE HALO_NMM_MEMBRANE_RELAX_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_MEMBRANE_RELAX_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_MEMBRANE_RELAX_sub
...
SUBROUTINE HALO_NMM_MEMBRANE_MASK_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_MEMBRANE_MASK_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_MEMBRANE_MASK_sub
...
SUBROUTINE HALO_NMM_MEMBRANE_INTERP_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_MEMBRANE_INTERP_inline.inc')
CALL rsl_comm_iter_init(2,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 2 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_MEMBRANE_INTERP_sub
