...
SUBROUTINE HALO_NMM_INIT_41_sub ( grid, &
  local_communicator, &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_INIT_41_inline.inc')
...
IF ( SIZE(grid%dqrcudt,1)*SIZE(grid%dqrcudt,2) .GT. 1 ) THEN
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%dqicudt,1)*SIZE(grid%dqicudt,2) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%dqicudt, 5,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%dqscudt,1)*SIZE(grid%dqscudt,2) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%dqscudt, 5,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_INIT_41_sub
...
SUBROUTINE HALO_NMM_A_3_sub ( grid, &
  num_moist, &
  moist, &
  num_scalar, &
  scalar, &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_A_3_inline.inc')
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_A_3_sub
...
SUBROUTINE HALO_NMM_B_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_B_inline.inc')
CALL rsl_comm_iter_init(2,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 2 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
SUBROUTINE HALO_NMM_C_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_C_inline.inc')
CALL rsl_comm_iter_init(3,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 3 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
SUBROUTINE HALO_NMM_D_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_D_inline.inc')
CALL rsl_comm_iter_init(3,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 3 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
SUBROUTINE HALO_NMM_E_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_E_inline.inc')
CALL rsl_comm_iter_init(2,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 2 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
SUBROUTINE HALO_NMM_F_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
SUBROUTINE HALO_NMM_F1_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_F1_inline.inc')
CALL rsl_comm_iter_init(5,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 5 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_F1_sub
...
SUBROUTINE HALO_NMM_G_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_G_inline.inc')
CALL rsl_comm_iter_init(3,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 3 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
SUBROUTINE HALO_NMM_H_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_H_inline.inc')
...
SUBROUTINE HALO_NMM_I_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_I_inline.inc')
CALL rsl_comm_iter_init(3,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 3 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
SUBROUTINE HALO_NMM_I_3_sub ( grid, &
  num_moist, &
  moist, &
  num_scalar, &
  scalar, &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_I_3_inline.inc')
CALL rsl_comm_iter_init(3,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 3 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_I_3_sub
...
SUBROUTINE HALO_NMM_J_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_J_inline.inc')
...
SUBROUTINE HALO_NMM_J_3_sub ( grid, &
  num_moist, &
  moist, &
  num_scalar, &
  scalar, &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_J_3_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
DO itrace = PARAM_FIRST_SCALAR, num_scalar
 IF ( SIZE(scalar,1)*SIZE(scalar,2) .GT. 1 ) THEN
  CALL RSL_LITE_PACK ( local_communicator,&
scalar ( grid%sm31,grid%sm32,grid%sm33,itrace),1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
4, 0, 0, DATA_ORDER_XYZ, 0, &
mytask, ntasks, ntasks_x, ntasks_y,       &
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_J_3_sub
...
SUBROUTINE HALO_NMM_K_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_K_inline.inc')
CALL rsl_comm_iter_init(2,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 2 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
SUBROUTINE HALO_NMM_L_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_L_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
SUBROUTINE HALO_NMM_L_3_sub ( grid, &
  num_moist, &
  moist, &
  num_scalar, &
  scalar, &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_L_3_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_L_3_sub
...
SUBROUTINE HALO_NMM_MG_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_MG_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_MG_sub
...
SUBROUTINE HALO_NMM_MG2_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_MG2_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_MG2_sub
...
SUBROUTINE HALO_NMM_MG3_sub ( grid, &
  config_flags, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
...
CALL wrf_debug(2,'calling inc/HALO_NMM_MG3_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_NMM_MG3_sub
