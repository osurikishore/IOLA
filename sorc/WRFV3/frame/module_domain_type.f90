...
integer                                  :: iseed_sppt
integer                                  :: spp_mp
real                                     :: gridpt_stddev_spp_mp
real                                     :: stddev_cutoff_spp_mp
real                                     :: lengthscale_spp_mp
real                                     :: timescale_spp_mp
integer                                  :: vertstruc_spp_mp
integer                                  :: iseed_spp_mp
integer                                  :: isppt_mp
real                                     :: gridpt_stddev_isppt_mp
real                                     :: stddev_cutoff_isppt_mp
real                                     :: lengthscale_isppt_mp
real                                     :: timescale_isppt_mp
integer                                  :: vertstruc_isppt_mp
integer                                  :: iseed_isppt_mp
integer                                  :: isppt_pbl
real                                     :: gridpt_stddev_isppt_pbl
real                                     :: stddev_cutoff_isppt_pbl
real                                     :: lengthscale_isppt_pbl
real                                     :: timescale_isppt_pbl
integer                                  :: vertstruc_isppt_pbl
integer                                  :: iseed_isppt_pbl
integer                                  :: isppt_rad
real                                     :: gridpt_stddev_isppt_rad
real                                     :: stddev_cutoff_isppt_rad
real                                     :: lengthscale_isppt_rad
real                                     :: timescale_isppt_rad
integer                                  :: vertstruc_isppt_rad
integer                                  :: iseed_isppt_rad
integer                                  :: isppt_conv
real                                     :: gridpt_stddev_isppt_conv
real                                     :: stddev_cutoff_isppt_conv
real                                     :: lengthscale_isppt_conv
real                                     :: timescale_isppt_conv
...
integer   ,DIMENSION(:)       ,POINTER   :: force_sppt
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: field_spp_mp
real      ,DIMENSION(:,:,:)   ,POINTER   :: pattern_spp_mp
real      ,DIMENSION(:,:,:)   ,POINTER   :: pattern_isppt_mp
real      ,DIMENSION(:,:,:)   ,POINTER   :: pattern_isppt_pbl
real      ,DIMENSION(:,:,:)   ,POINTER   :: pattern_isppt_rad
real      ,DIMENSION(:,:,:)   ,POINTER   :: pattern_isppt_conv
...
real      ,DIMENSION(:,:)     ,POINTER   :: spforcc_isppt_mp
real      ,DIMENSION(:,:)     ,POINTER   :: spforcs_isppt_mp
real      ,DIMENSION(:,:)     ,POINTER   :: sp_amp_isppt_mp
real      ,DIMENSION(:,:)     ,POINTER   :: spforcc_isppt_pbl
real      ,DIMENSION(:,:)     ,POINTER   :: spforcs_isppt_pbl
real      ,DIMENSION(:,:)     ,POINTER   :: sp_amp_isppt_pbl
real      ,DIMENSION(:,:)     ,POINTER   :: spforcc_isppt_rad
real      ,DIMENSION(:,:)     ,POINTER   :: spforcs_isppt_rad
real      ,DIMENSION(:,:)     ,POINTER   :: sp_amp_isppt_rad
real      ,DIMENSION(:,:)     ,POINTER   :: spforcc_isppt_conv
real      ,DIMENSION(:,:)     ,POINTER   :: spforcs_isppt_conv
real      ,DIMENSION(:,:)     ,POINTER   :: sp_amp_isppt_conv
real      ,DIMENSION(:,:)     ,POINTER   :: spforcc_spp_mp
real      ,DIMENSION(:,:)     ,POINTER   :: spforcs_spp_mp
real      ,DIMENSION(:,:)     ,POINTER   :: sp_amp_spp_mp
...
integer   ,DIMENSION(:)       ,POINTER   :: iseedarr_isppt_mp
integer   ,DIMENSION(:)       ,POINTER   :: iseedarr_isppt_pbl
integer   ,DIMENSION(:)       ,POINTER   :: iseedarr_isppt_rad
integer   ,DIMENSION(:)       ,POINTER   :: iseedarr_isppt_conv
integer   ,DIMENSION(:)       ,POINTER   :: iseedarr_spp_mp
...
integer   ,DIMENSION(:)       ,POINTER   :: nest_imid
integer   ,DIMENSION(:)       ,POINTER   :: nest_jmid
real      ,DIMENSION(:,:)     ,POINTER   :: cuprecip_swath
real      ,DIMENSION(:,:)     ,POINTER   :: precip_swath
real      ,DIMENSION(:,:)     ,POINTER   :: windsq_swath
real      ,DIMENSION(:,:)     ,POINTER   :: suswind
real      ,DIMENSION(:,:)     ,POINTER   :: wind10_ratio
real      ,DIMENSION(:,:)     ,POINTER   :: suswind_swath
...
real      ,DIMENSION(:,:)     ,POINTER   :: hres_lu_index
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: sm_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: sm_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: sm_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: sm_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: sm_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: sm_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: sm_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: sm_btye
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: varlen
real      ,DIMENSION(:,:,:)   ,POINTER   :: hadjust
...
real      ,DIMENSION(:,:)     ,POINTER   :: scurx
real      ,DIMENSION(:,:)     ,POINTER   :: scury
real      ,DIMENSION(:,:)     ,POINTER   :: charn
real      ,DIMENSION(:,:)     ,POINTER   :: msang
real      ,DIMENSION(:,:)     ,POINTER   :: rchno
real      ,DIMENSION(:,:)     ,POINTER   :: zsig1
real      ,DIMENSION(:,:)     ,POINTER   :: ulowl
real      ,DIMENSION(:,:)     ,POINTER   :: vlowl
real      ,DIMENSION(:,:)     ,POINTER   :: rc2d
real      ,DIMENSION(:,:,:)   ,POINTER   :: dku3d
real      ,DIMENSION(:,:,:)   ,POINTER   :: dkt3d
real      ,DIMENSION(:,:)     ,POINTER   :: scalefun
real      ,DIMENSION(:,:)     ,POINTER   :: scalefun1
real      ,DIMENSION(:,:)     ,POINTER   :: sigmu
real      ,DIMENSION(:,:)     ,POINTER   :: sigmu1
real      ,DIMENSION(:,:,:)   ,POINTER   :: dthcudt
real      ,DIMENSION(:,:,:)   ,POINTER   :: dqvcudt
real      ,DIMENSION(:,:,:)   ,POINTER   :: dqrcudt
real      ,DIMENSION(:,:,:)   ,POINTER   :: dqccudt
real      ,DIMENSION(:,:,:)   ,POINTER   :: dqicudt
real      ,DIMENSION(:,:,:)   ,POINTER   :: dqscudt
real      ,DIMENSION(:,:,:)   ,POINTER   :: dthbldt
real      ,DIMENSION(:,:,:)   ,POINTER   :: dqvbldt
real      ,DIMENSION(:,:,:)   ,POINTER   :: dubldt
real      ,DIMENSION(:,:,:)   ,POINTER   :: dvbldt
...
integer   ,DIMENSION(:,:)     ,POINTER   :: ierr_shallow
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: hrswpd
real      ,DIMENSION(:,:,:)   ,POINTER   :: hrlwpd
real      ,DIMENSION(:,:)     ,POINTER   :: swddir
real      ,DIMENSION(:,:)     ,POINTER   :: swddirc
real      ,DIMENSION(:,:)     ,POINTER   :: swddni
real      ,DIMENSION(:,:)     ,POINTER   :: swddnic
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: train_ins
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: tke_mynn
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: soilcomp
real      ,DIMENSION(:,:)     ,POINTER   :: soilcl1
real      ,DIMENSION(:,:)     ,POINTER   :: soilcl2
real      ,DIMENSION(:,:)     ,POINTER   :: soilcl3
real      ,DIMENSION(:,:)     ,POINTER   :: soilcl4
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: gecros_state
