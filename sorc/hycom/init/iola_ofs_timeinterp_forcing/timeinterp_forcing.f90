PROGRAM timeinterp_forcing
  ...
  ! added by Sas
  !INCLUDE 'mpif.h'  ! Include MPI header
  !INTEGER :: IERROR
  ! till here
  ...
  !
  ! Loop over records
  write(*,*) 'looping over ', num_records
